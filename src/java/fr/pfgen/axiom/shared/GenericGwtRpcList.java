package fr.pfgen.axiom.shared;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import fr.pfgen.axiom.client.datasources.GenericGwtRpcDataSource;
import fr.pfgen.axiom.client.services.GenericGwtRpcService;
