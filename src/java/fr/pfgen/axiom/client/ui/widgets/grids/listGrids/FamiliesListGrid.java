...
import fr.pfgen.axiom.client.datasources.FamiliesDS;

/**
 *
 * @author eric
 */
public class FamiliesListGrid extends ListGrid{
    
    public FamiliesListGrid(){
		
		//DataSource datasource = new ProjectsDS();
		
		this.setTitle("Families");
		this.setDataSource(new FamiliesDS());
		this.setEmptyCellValue("--");
		this.setLayoutAlign(Alignment.CENTER);
		
		ListGridField idField = new ListGridField("family_id");
		idField.setAlign(Alignment.CENTER);
		idField.setType(ListGridFieldType.INTEGER);
		idField.setWidth(10);
		idField.setHidden(true);
		ListGridField nameField = new ListGridField("family_name");
		nameField.setAlign(Alignment.CENTER);
		nameField.setType(ListGridFieldType.TEXT);
		nameField.setWidth(10);
                ListGridField propositusField = new ListGridField("propositus");
		propositusField.setAlign(Alignment.CENTER);
		propositusField.setType(ListGridFieldType.TEXT);
		propositusField.setWidth(10);
		...
		this.setFields(idField,nameField,propositusField,userField,createdField);
		...
		this.addSort(new SortSpecifier("family_id",SortDirection.DESCENDING));
